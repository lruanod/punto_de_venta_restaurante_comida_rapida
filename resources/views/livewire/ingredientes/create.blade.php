...
<div wire:ignore.self class="modal fade bd-example-modal-lg" id="addingrediente" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="addingrediente">Registrar Ingrediente</h5>
            ...
            <div class="modal-body">
                <div class="container col-sm-10">
                    <div class="card" style="background: linear-gradient(to bottom, #3C3E40  , #1B92F0 );">
                        ...
                        <div class="card-body">
                            @include('livewire.ingredientes.form')
                            <br>
