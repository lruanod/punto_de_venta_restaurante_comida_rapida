...
<div class="row form-group">
    ...
    <input type="number" wire:model="cantidad" class="form-control col-md-5"  placeholder="0"  min="0" wire:change="change" >
...
<div class="row form-group">
    <label for="observacion" class="col-5 text-white">Observaciones</label>
    <textarea class="form-control" wire:model="observacion"  rows="3"></textarea>
    @error('observacion') <span class="text-warning">{{$message}}</span> @enderror
</div>
