        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container col-sm-12">
                    <div class="card" >
                        <div class="card-body">
                            @include('livewire.pedidos.pedidoform')
                            <br>
                            <div class="row col-sm-6">
                                <div class="row form-group">
                                    <label for="descuento" class="col-md-5 text-dark">Descuento</label>
                                    <input type="number" wire:model="tdescuento" placeholder="0.00"  min="0" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="this.parentNode.parentNode.style.backgroundColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?inherit':'red'" class="form-control col-md-5" readonly="readonly">
                                    @error('tdescuento') <span class="text-warning">{{$message}}</span> @enderror
                                </div>
