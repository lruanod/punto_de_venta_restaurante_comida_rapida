<!-- modal usuario-->
<div wire:ignore.self class="modal fade bd-example-modal-lg" id="addusuario" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title " id="addusuario">Registrar usuario</h5>
